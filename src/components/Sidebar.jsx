  ...
  return (
    <div className="h-screen w-2/6 bg-background text-text fixed flex flex-col items-center justify-between pt-12 border-r-2 border-slate-200 ">
      <div className="flex flex-col items-center py-8">
        ...
        <h2 className="text-l mb-8 text-center text-text">Computer Science Student <br/> at<span className="hover:text-slate-100 cursor-pointer"> University of Arizona </span></h2>
      </div>
