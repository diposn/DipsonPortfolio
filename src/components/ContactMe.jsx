  ...
  return (
    <section className="bg-background py-20 md:px-20 lg:px-40  text-slate-200" >
      <div className="ml-64 max-w-md pb-16  text-sm text-slate-500">
        ...
        Designed using uizard and coded in Visual Studio Code by yours truly. Built with React.js and Tailwind CSS, deployed with Github. </p>
        <p className="text-sm mb-4">
        You can contact me via email at  <a href="mailto:dkc04@arizona.edu" className="text-cyan-700"><span className="hover:text-zinc-50">dkc04@arizona.edu</span></a></p>
        <p className="text-sm mb-4">
